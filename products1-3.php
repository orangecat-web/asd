...
<!-- LIGHT SECTION -->
<section class="lightSection clearfix pageHeader prod_item03"><!--prod_item01 食尚精品,prod_item02 質感生活,prod_item03 美妝親子,prod_item04 健康活力-->
	<div class="container">
		<div class="row">
			<div class="col-xs-6">
					...
					<div class="col-sm-4 col-xs-12">
						<div class="productBox">
							<div onclick="location.href='product-detail.php'" class="productImage clearfix">
								...
								<div class="productMasking proditem03">
